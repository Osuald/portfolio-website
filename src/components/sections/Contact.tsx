...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await emailjs.send(
        ...
        {
          from_name: form.name,
          from_time: new Date().toLocaleString("en-US", {
            dateStyle: "medium",
            timeStyle: "short",
          }),
  ...
  return (
    <section
      id="contact"
      className="section-padding bg-cream-100 dark:bg-night-900 relative overflow-hidden"
    >
          ...
          >
            {contactDetails.map(({ icon: Icon, label, value, href }) => (
              ...
              >
                ...
                <div>
                  <p className="text-[11px] font-mono text-ink-300 dark:text-ink-600 mb-0.5 uppercase tracking-wider">
                    {label}
                  </p>
                  {href ? (
                    <a
            ...
            <div className="bg-white dark:bg-night-800 border border-cream-300 dark:border-night-700 rounded-2xl p-6 md:p-8">
              {status === "success" ? (
                ...
                >
                  ...
                  <h3 className="font-mono text-lg font-bold text-ink-900 dark:text-cream-100 mb-1.5">
                    Message Sent!
                  </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                  <h3 className="font-mono text-base font-bold text-ink-900 dark:text-cream-100 mb-5">
                    Send a Message
                  </h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label
                        htmlFor="name"
                        className="block text-xs font-medium text-ink-500 dark:text-ink-400 mb-1.5"
                      >
                  ...
                  <div>
                    ...
                    <div className="flex justify-between mt-1">
                      ...
                      <span
                        className={`text-xs font-mono ${form.message.length < 20 ? "text-ink-300" : "text-ink-400"}`}
                      >
                        {form.message.length}
                      </span>
                    </div>
